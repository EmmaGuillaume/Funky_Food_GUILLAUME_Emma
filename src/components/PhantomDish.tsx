const PhantomDish = () => {
  return (
    <div className="group" data-discover="true">
      <div className="bg-white rounded-3xl overflow-hidden shadow-xl transform hover:-translate-y-2 transition-all duration-300 border-4 border-transparent">
