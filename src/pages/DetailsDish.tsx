    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-400 via-pink-400 to-orange-300">
      <div className="relative h-[500px] overflow-hidden">
        <img
          ...
          alt="Pizza Margherita classNameique"
        ...
        <div className="absolute bottom-8 left-8 right-8">
          <h1 className="text-5xl md:text-7xl font-black text-white mb-4 drop-shadow-2xl">
            Pizza Margherita classNameique
          </h1>
        ...
        <div className="max-w-6xl mx-auto px-4 py-12">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
            <div className="bg-gradient-to-br from-purple-200 to-purple-300 p-6 rounded-3xl text-center transform rotate-1 shadow-lg">
              ...
              <div className="font-black text-2xl text-purple-900">20</div>
            ...
            <div className="bg-gradient-to-br from-pink-200 to-pink-300 p-6 rounded-3xl text-center transform -rotate-1 shadow-lg">
              ...
              <div className="font-black text-2xl text-pink-900">15</div>
            ...
            <div className="bg-gradient-to-br from-orange-200 to-orange-300 p-6 rounded-3xl text-center transform rotate-1 shadow-lg">
              ...
              <div className="font-black text-2xl text-orange-900">4</div>
            ...
            <div className="bg-gradient-to-br from-yellow-200 to-yellow-300 p-6 rounded-3xl text-center transform -rotate-1 shadow-lg">
              ...
              <div className="font-black text-2xl text-yellow-900">300</div>
              ...
              <ol className="space-y-4">
                ...
                <li className="bg-white p-4 rounded-2xl shadow-md">
                  <div className="flex gap-3">
                    ...
                    <p className="text-gray-800 pt-1">
                      Étalez la pâte à pizza et répartissez la sauce tomate
                      uniformément.
                    </p>
                  </div>
                </li>
                <li className="bg-white p-4 rounded-2xl shadow-md">
                  <div className="flex gap-3">
                    ...
                    <p className="text-gray-800 pt-1">
                      Garnissez de tranches de mozzarella fraîche et de feuilles
                      de basilic.
                    </p>
                  </div>
                </li>
                <li className="bg-white p-4 rounded-2xl shadow-md">
                  <div className="flex gap-3">
                    ...
                    <p className="text-gray-800 pt-1">
                      Arrosez d'huile d'olive et assaisonnez de sel et poivre.
                    </p>
                  </div>
                </li>
                <li className="bg-white p-4 rounded-2xl shadow-md">
                  <div className="flex gap-3">
                    ...
                    <p className="text-gray-800 pt-1">
                      Enfournez pendant 12-15 minutes jusqu'à ce que la croûte
                      soit dorée.
                    </p>
                  </div>
                </li>
